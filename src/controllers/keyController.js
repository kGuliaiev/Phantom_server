...
// Получение набора ключей для начала общения
export const requestKey = async (req, res) => {
    try {
        ...
        const oneTimePreKey = user.oneTimePreKeys.shift(); // удалить первый ключ
        await user.save();
...
// Удаление использованного одноразового ключа по имени
